...
namespace _0502
{
    public partial class Form2 : Form
    {
        ...
        private void Kh_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (patriot)
            {
                KeyPress.Text = KeyPress.Text.Replace("Россія", "лайно");
                KeyPress.Text = KeyPress.Text.Replace("Россії", "лайні");
                KeyPress.Text = KeyPress.Text.Replace("Росія", "лайно");
                KeyPress.Text = KeyPress.Text.Replace("россія", "лайно");
                KeyPress.Text = KeyPress.Text.Replace("росія", "лайно");
                KeyPress.Text = KeyPress.Text.Replace("Путін", "птн-пнх");
                KeyPress.Text = KeyPress.Text.Replace("Скабєєва", "зливний бачок");
                KeyPress.Text = KeyPress.Text.Replace("Соловйов", "вечірній мудозвон");
            }
            ...
            foreach (string word in keyWords)
            {
                if (check.Contains(word))
                {
                    ...
                    /*if (System.IO.File.Exists(path) && this.Opacity == 1 && check.Contains(word))
                    {
                        // Запустити програму за замовчуванням для відкриття файлу
        ...
        private void Kh_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            foreach (var key in keys)
            {
                /*if (key == "Shift")
                {
                    ...
                    KeyPress.ForeColor = Color.Red;
                }
                else KeyPress.ForeColor = Color.Black;*/
